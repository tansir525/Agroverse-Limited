      ...
      <Container sx={styles.container}>
        <Grid sx={styles.grid}>
          <Box sx={styles.content}>
            ...
            <h2>We ensure best quality of Food Product</h2>
            
            <Text as="p">
             Lorem ipsum dolor, sit amet consectetur adipisicing elit. Libero impedit odit sint officia aliquid architecto ex cumque doloribus officiis dicta facilis ipsa nulla perspiciatis natus
            </Text>
